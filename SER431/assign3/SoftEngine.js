...
(function (SoftEngine) {
    ...
    var Device = (function () {
        function Device(canvas) {
            ...
            this.mode = 0;
            this.count = 0;
            this.lightPos = new BABYLON.Vector3(0, 10, 0);
            this.digits = 15;
        }
        ...
        Device.prototype.catclarkSubDev = function(mesh, state) {
            var wtf = Math.pow(10, this.digits);
            ...
            for (var i = 0; i < mesh.halfEdges.length; i++) {
                ...
                midPoints[i].Coordinates.x = Math.round(midPoints[i].Coordinates.x * wtf) / wtf;
            	midPoints[i].Coordinates.y = Math.round(midPoints[i].Coordinates.y * wtf) / wtf;
            	midPoints[i].Coordinates.z = Math.round(midPoints[i].Coordinates.z * wtf) / wtf;
            }
            ...
            for (var i = 0; i < mesh.Vertices.length; i++) {
            	var gofa = mesh.Vertices[i].Coordinates;
            	gofa.x = Math.round(gofa.x * wtf) / wtf;
            	gofa.y = Math.round(gofa.y * wtf) / wtf;
            	gofa.z = Math.round(gofa.z * wtf) / wtf;
            }
            this.digits--;
            // sup with this ^^ ?
            var facept;
            var faceptIdx, midpt1Idx, midpt2Idx;
            var newHalfies = new Array(0);
            ...
            for (var i = 0; i < mesh.halfEdges.length; i++) {
                ...
                midpt1Idx = this.vectorIndexOf(midPoints[i], mesh.Vertices);
                if (midpt1Idx === -1) {midpt1Idx = mesh.Vertices.length;}
	            ...
	            midpt2Idx = this.vectorIndexOf(midPoints[mesh.halfEdges[i].prev], mesh.Vertices);
	            if (midpt2Idx === -1) {midpt2Idx = mesh.Vertices.length;}
        ...
        Device.prototype.vectorIndexOf = function(vect, array) {
